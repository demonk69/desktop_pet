...
static const pet_animation_frame_t idle_frames[] = {
    FRAME(PET_ASSET_TEST_CHARACTER, 700U),
    FRAME(PET_ASSET_TEST_CHARACTER_IDLE_1, 700U)
};
static const pet_animation_frame_t blink_frames[] = {
    FRAME(PET_ASSET_TEST_CHARACTER_BLINK_HALF, 80U),
    FRAME(PET_ASSET_TEST_CHARACTER_BLINK_CLOSED, 100U),
    FRAME(PET_ASSET_TEST_CHARACTER_BLINK_HALF, 80U),
    FRAME(PET_ASSET_TEST_CHARACTER, 80U)
};
static const pet_animation_frame_t look_left_frames[] = {
    FRAME(PET_ASSET_TEST_CHARACTER, 500U), FRAME(PET_ASSET_TEST_CHARACTER, 120U)
};
static const pet_animation_frame_t look_right_frames[] = {
    FRAME(PET_ASSET_TEST_CHARACTER, 500U), FRAME(PET_ASSET_TEST_CHARACTER, 120U)
};
static const pet_animation_frame_t happy_frames[] = {
    FRAME(PET_ASSET_TEST_CHARACTER_HAPPY_0, 180U),
    FRAME(PET_ASSET_TEST_CHARACTER_HAPPY_1, 180U),
    FRAME(PET_ASSET_TEST_CHARACTER_HAPPY_0, 180U),
    FRAME(PET_ASSET_TEST_CHARACTER_HAPPY_1, 180U)
};
static const pet_animation_frame_t sleep_frames[] = {
    FRAME(PET_ASSET_TEST_CHARACTER, 700U), FRAME(PET_ASSET_TEST_CHARACTER, 700U)
};

static const pet_animation_clip_t clips[PET_ANIM_COUNT] = {
    [PET_ANIM_BOOT] = { boot_frames, 2U, false },
    [PET_ANIM_IDLE] = { idle_frames, 2U, true },
